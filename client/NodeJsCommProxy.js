...
TRom.NodeJsCommProxy.prototype.secRequest = function (binRequest) {
    ...
    var _decode = function (data) {
        try {
            ...
            response.costtime = data.request.costtime;
            response.return   = is.readInt32(0, true, TarsStream.Int32);
            response.arguments.binResponse = is.readBytes(2, true, TarsStream.BinBuffer);
    ...
    return this._worker.tars_invoke('secRequest', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}
